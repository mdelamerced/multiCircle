...
void setup() {
  ...
  video = new CaptureAxisCamera(this, "128.122.151.28", 640, 480, false);
   video2 = new CaptureAxisCamera2(this, "128.122.151.237", 640, 480, false);
   video3 = new CaptureAxisCamera3(this, "128.122.151.29", 640, 480, false);
   video4 = new CaptureAxisCamera4(this, "128.122.151.82", 640, 480, false);
  ...
  myRemoteLocation3 = new NetAddress("198.1.100.2", 32000);
  myRemoteLocation1 = new NetAddress("198.1.100.3", 32000);
  myRemoteLocation2 = new NetAddress("198.1.100.4", 32000);
}
