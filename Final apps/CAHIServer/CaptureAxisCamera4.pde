...
public class CaptureAxisCamera4 extends PImage implements Runnable {
  ...
  public CaptureAxisCamera4(PApplet _parent, String _ip, int _w, int _h, boolean _useMJPGStream) {
    ip = _ip;
    parent = _parent;
